...
| `platforms` | `linux/amd64,linux/arm64` | Comma-separated list of target platforms to build. Use a narrower list for software that is unavailable on some architectures, for example `linux/amd64` for STAR. |
